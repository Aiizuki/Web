 ...
 */
final class Version20220211145917 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__activity AS SELECT id, nom, description FROM activity');
        ...
        $this->addSql('INSERT INTO activity (id, nom, description) SELECT id, nom, description FROM __temp__activity');
