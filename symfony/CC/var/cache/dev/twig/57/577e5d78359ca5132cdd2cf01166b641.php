...
class __TwigTemplate_6cd52579cb2d2bc97f319363729c5f92 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        echo "\" onsubmit=\"return confirm('Etes vous sur de vouloir supprimer cette activité ?');\">
    <input type=\"hidden\" name=\"_token\" value=\"";
        // line 2
        echo twig_escape_filter($this->env, $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderCsrfToken(("delete" . twig_get_attribute($this->env, $this->source, (isset($context["activity"]) || array_key_exists("activity", $context) ? $context["activity"] : (function () { throw new RuntimeError('Variable "activity" does not exist.', 2, $this->source); })()), "id", [], "any", false, false, false, 2))), "html", null, true);
        echo "\">
    <button class=\"btn btn-success\" style=\"margin:2px\">Delete</button>
</form>
";
    ...
    {
        return new Source("<form method=\"post\" action=\"{{ path('activity_delete', {'id': activity.id}) }}\" onsubmit=\"return confirm('Etes vous sur de vouloir supprimer cette activité ?');\">
    <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('delete' ~ activity.id) }}\">
    <button class=\"btn btn-success\" style=\"margin:2px\">Delete</button>
</form>
", "activity/_delete_form.html.twig", "/var/www/html/cc42/CC/templates/activity/_delete_form.html.twig");
    }
}
